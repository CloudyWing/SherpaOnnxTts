...
| 參數名稱 | 說明 | 適用情境 | 範例 |
| :--- | :--- | :--- | :--- |
| **voice** | **說話者 ID**。決定使用模型內的哪個角色 (字串轉數值)。 | POST /v1/audio/speech | `0`, `1` |
| **sid** / **speaker_id** | **說話者 ID**。決定使用模型內的哪個角色。 | GET /tts | `0`, `1` |
...
| **model** | **模型引擎**。決定載入哪個模型資料夾。 | POST /v1/audio/speech | `vits-zh-aishell3` |
...
├── tests/               # 測試專案
│   └── SherpaOnnxTts.Tests/ # NUnit 單元測試
